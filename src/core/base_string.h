...
internal String8 Trim8Spaces(String8 str);

// NOTE(afb) :: Comparison
internal b8 Str8Match(String8 a, String8 b, MatchFlags flags);
internal b8 operator==(String8& a, String8& b);
internal u64 FindStr8(String8 str, String8 search); // TODO(afb) :: Match flags
...
#define Str8ListPushF(arena, sb, format, ...) Str8ListPush(arena, sb, Str8PushF(arena, format, __VA_ARGS__))
...
internal String8Array Str8ListToArray(Arena* arena, String8List);
